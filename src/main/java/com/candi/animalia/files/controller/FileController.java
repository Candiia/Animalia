package com.candi.animalia.files.controller;


import com.candi.animalia.files.dto.FileResponse;
import com.candi.animalia.files.model.FileMetadata;
import com.candi.animalia.files.service.StorageService;
import com.candi.animalia.files.utils.MimeTypeDetector;
...
public class FileController {
    ...
    //poner el mismo nombre que en el requesPart
    @PostMapping("/upload")
    ...
    //cadena de caracteres mas un punto
